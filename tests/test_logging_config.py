...
from ulysses_jepa import logging_config
...
def test_setup_logging_returns_named_logger():
    log = logging_config.setup_logging("ulysses_jepa.test")
    assert log.name == "ulysses_jepa.test"
...
def test_extra_kwargs_appear_in_json_output_if_available():
    ...
    logging.getLogger("ulysses_jepa.test").info(
