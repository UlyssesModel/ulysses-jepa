...
This script automates that comparison for the ulysses-jepa stack:
...
from ulysses_jepa.interfaces import KirkClient, KirkMode
from ulysses_jepa.kirk_client import (
    KirkPipelineClient,
    KirkSubprocessClient,
    StubKirkClient,
)
from ulysses_jepa.uhura_io import load_uhura_glob
