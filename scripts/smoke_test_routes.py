...
Hits /v2/models/ulysses-jepa{,-a,-b}/infer with the same sample payload,
...
Usage:
    ...
    oc port-forward svc/ulysses-jepa-predictor -n kavara-ai 8080:80 &
...
def main() -> int:
    ...
    routes = [
        ("ulysses-jepa", "C — embedding injection", True),       # always strict
        ("ulysses-jepa-a", "A — raw text", args.strict_pipeline_a),
        ("ulysses-jepa-b", "B — compressed text", args.strict_pipeline_b),
    ]
