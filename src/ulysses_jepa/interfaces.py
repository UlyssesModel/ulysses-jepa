"""Core type contracts for ulysses-jepa.
...
The ulysses-jepa projection adapter taps off Layer 2's input matrix (the rich
...
class KirkMode(str, Enum):
    ...
    For ulysses-jepa training we use ACTIVE_INFERENCE (returns all outputs in
